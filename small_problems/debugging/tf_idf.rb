...
def tfidf(term, document, documents)
  tf_output = tf(term, document)
  idf_output = idf(term, documents)
  output = tf_output * idf_output
  output
end
...
def tf(term, document)
  tf = document.split(/[\s-]/).count { |word| word.downcase == term }
  tf
end
...
def idf(term, documents)
  ...
  return Math.log(number_of_documents / number_of_documents_with_term.to_f)
end
